export default function ScheduleHeader() {
  return (
    <table className="schedule-view-header sticky top-0 left-0 grid grid-cols-6 z-30 bg-indigo-200 w-full grid-flow-col divide-x-2 divide-zinc-600 h-16 text-xl">
